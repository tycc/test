define(['underscore', 'jquery', 'butterfly/extend'], function(_, $, extend){
	...
	var dsOptions = ['identifier', 'url', 'requestParams', 'pageParam', 'pageSizeParam', 'startParam', 'countParam', 'storage', 'type'];
	...
	var DataSource = function(options){
		...
		var defaults = {
			pageParam: 'currentPage', pageSizeParam: 'pageSize',
					...
					success: function(resultArray){
						...
						if(resultArray && resultArray.data) {
							_.each(resultArray.data, function(element, index){
								me.set((page -1) * pageSize + index, element);
							});
						} 
